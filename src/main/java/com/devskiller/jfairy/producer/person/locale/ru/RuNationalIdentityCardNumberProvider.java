 ...
 * @since 15.03.15
 */
public class RuNationalIdentityCardNumberProvider implements NationalIdentityCardNumberProvider {
	...
	@Inject
	public RuNationalIdentityCardNumberProvider(BaseProducer baseProducer) {
